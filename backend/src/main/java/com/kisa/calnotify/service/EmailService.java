...
public class EmailService {
    ...
    @Async
    public void sendOrganizerMail(String to, String name, String eventTitle, String description, String start, String end) {
        try {
    ...
    @Async
    public void participantsMail(String to, String name, String eventTitle, String description, String start, String end) {
        try {
            Context context = new Context();
            context.setVariable("name", name);
            context.setVariable("eventTitle", eventTitle);
